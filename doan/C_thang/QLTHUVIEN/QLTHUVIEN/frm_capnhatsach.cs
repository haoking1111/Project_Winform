...
namespace WindowsFormsApplication1
{
    public partial class frm_capnhatsach : Form
    {
        ...
        private void loaddata()
        {
            ...
            dt_capnhatsach.Columns[2].HeaderText = "Năm xuất bản";
            dt_capnhatsach.Columns[3].HeaderText = "Mã nhà xuất bản";
            dt_capnhatsach.Columns[4].HeaderText = "Mã thể loại";
            dt_capnhatsach.Columns[5].HeaderText = "Mã tác giả";
        ...
        private void dt_luoi_SelectionChanged(object sender, EventArgs e)
        {
            ...
            txt_namxb.Text = dt_capnhatsach.CurrentRow.Cells[2].Value.ToString();
            ComboBox_nhaxb.Text = dt_capnhatsach.CurrentRow.Cells[3].Value.ToString();
            ComboBox_theloai.Text = dt_capnhatsach.CurrentRow.Cells[4].Value.ToString();
            ComboBox_matacgia.Text = dt_capnhatsach.CurrentRow.Cells[5].Value.ToString();
        }
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (t.thucthidulieu("update  SACH set tensach=N'" + txt_tensach.Text + "', namxb=N'" + txt_namxb.Text + "', manxb='" + ComboBox_nhaxb.Text + "', matheloai='" + ComboBox_theloai.Text + "', matacgia='" + ComboBox_matacgia.Text + "'where masach=N'" + txt_masach.Text + "'") == true)
                {
